...
- 回复效果评估升级为 v2：基于完整上下文和显式引用进行语义归因，以回应度、情感接受度和聊天推动度评估每条回复，并支持同聊天流同场景相对分及策略/模型/Prompt 版本统计。
...
- 回复效果页面新增“数据分析 / 评估浏览”双视图；评估浏览支持按聊天流、状态、策略、模型及置信度筛选，按时间和各项分数排序，并以左侧记录列表、右侧上下文与归因证据的布局逐条查看评估。
