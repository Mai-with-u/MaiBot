...
const EXPECTED_FIELD_HOOKS: Array<[string, 'replace' | 'wrapper' | 'hidden']> = [
  ...
  ['chat.reply_timing.talk_value', 'wrapper'],
  ['chat.reply_timing.private_talk_value', 'wrapper'],
  ['chat.reply_timing.enable_talk_value_rules', 'wrapper'],
  ['chat.reply_timing.message_trigger_count', 'wrapper'],
